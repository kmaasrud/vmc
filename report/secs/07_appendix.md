...
The calculations:
First, we change the Laplacian to work with a cartesian two dimensional system:
...
From this we can find an analytical solution to the *quantum force* used in importance sampling, defined as
$$
F = 2\frac{\nabla \Psi_T}{\Psi_T} = 2 \frac{f^\prime g + f g^\prime}{fg}
$$
